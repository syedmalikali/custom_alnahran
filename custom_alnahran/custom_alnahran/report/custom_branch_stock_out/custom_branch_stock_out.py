...
def execute(filters=None):
    ...
    columns = [
        ...
        {"label": "Stock UOM", "fieldname": "stock_uom", "fieldtype": "Data"},
        {"label": "In Qty", "fieldname": "in_qty", "fieldtype": "Float"},
        {"label": "Basic Rate", "fieldname": "basic_rate", "fieldtype": "Currency"},
